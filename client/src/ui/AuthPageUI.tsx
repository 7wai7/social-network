            ...
            <form className="form" onSubmit={submit}>
                ...
                <div className="input-wrapper">
                    <input
                        ...
                        className={`login-input ${inputsData.login.isError ? 'error' : ''}`}
                    />
                    {
                        inputsData.login.isError && (
                            <span className="error-message">{inputsData.login.message}</span>
                        )
                    }
                </div>
                {
                    isSignup && (
                        <div className="input-wrapper">
                            <input
                                ...
                                className={`email-input ${inputsData.email.isError ? 'error' : ''}`}
                            />
                            {
                                inputsData.email.isError && (
                                    <span className="error-message">{inputsData.email.message}</span>
                                )
                            }
                        </div>
                    )
                ...
                <div className="input-wrapper">
                    <input
                        ...
                        className={`password-input ${inputsData.password.isError ? 'error' : ''}`}
                    />
                    <button className="show-password-toggle" type="button" onClick={() => togglePassword()}>
                        {
                            isShowPassword
                    ...
                    {
                        inputsData.password.isError && (
                            <span className="error-message">{inputsData.password.message}</span>
                        )
                    }
                </div>
                {
