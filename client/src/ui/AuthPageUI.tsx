...
export default function AuthPageUI(
    props: {
        ...
        messageRefs: {
            login: React.RefObject<HTMLSpanElement | null>,
            email: React.RefObject<HTMLSpanElement | null>,
            password: React.RefObject<HTMLSpanElement | null>
        },
        togglePasswordBtnRef: React.RefObject<HTMLButtonElement | null>,
        togglePassword: () => void,
        ...
        <div className="auth-panel">
            ...
            <form className="form" onSubmit={props.submit}>
                ...
                <div className="input-wrapper">
                    ...
                    <span className="error-message" hidden ref={props.messageRefs.password}>message</span>
                </div>
                {
                    !props.isSignup ? <button className="forgot-password-btn">Forgot password?</button> : ''
                }
                ...
                {
                    !props.isSignup && (<Link to="/register" className="no-account-btn">Don't have an account?</Link>)
                }
            </form>
        </div>
    )
