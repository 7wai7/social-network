            ...
            <div className="post-modal" hidden ref={props.postModalRef}>
                <div className="panel">
                    <div className="panel-top">
                        <button className="close-modal-btn svg-icon" onClick={() => props.layoutEmitter.emit('close-post-modal')}>
                            <svg
                                viewBox="0 0 24 24"
                                aria-hidden="true">
                    ...
                    <div className="scroll-area">
                        <textarea name="post" className="post-textarea textarea-autosize" placeholder="Write a post" value={props.text} onChange={(e) => props.setText(e.target.value)}></textarea>
                        <AttachedFilesPreview emitter={props.postModalEmitter} attachFileInputRef={attachFilesInputRef} />
                    </div>
